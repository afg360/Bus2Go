...
import dev.mainhq.bus2go.adapters.StopListElemsAdapterFactory
                ...
                withContext(Dispatchers.Main){
                     when(agency){
                        TransitAgency.STM -> {
                            ...
                            recyclerView.adapter = StopListElemsAdapterFactory.createStmStopListElemsAdapter(
                                stopNames, favourites, favouritesViewModel, routeId, direction, directionId, lastStop
                            )
                        }
                        ...
                        TransitAgency.EXO_TRAIN -> {
                            ...
                            recyclerView.adapter = StopListElemsAdapterFactory.createExoTrainStopListElemsAdapter(
                                stopNames, favourites, favouritesViewModel, routeId, routeName!!, directionId, direction, trainNum
                            )
                        }
                        ...
                        TransitAgency.EXO_OTHER -> {
                            ...
                            recyclerView.adapter = StopListElemsAdapterFactory.createExoOtherStopListElemsAdapter(
                                stopNames, favourites, favouritesViewModel, routeId, routeName, direction, headsign
                            )
                        }
                    }
